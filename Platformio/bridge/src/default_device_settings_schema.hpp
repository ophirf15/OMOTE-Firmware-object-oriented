...
static const char kDefaultDeviceSettingsSchema[] = R"OMOTE_SCHEMA({
  "version": 1,
      ...
      "fields": [
        ...
        },
        {
          ...
          "options": [
            ...
            { "label": "Alternating", "value": 1 },
            { "label": "First 5 sec", "value": 2 }
          ],
          "default": 0
        },
        {
          ...
          "options": [
            ...
            { "label": "Cloudflare", "value": "time.cloudflare.com" },
            { "label": "Windows", "value": "time.windows.com" },
            { "label": "Ubuntu", "value": "ntp.ubuntu.com" },
            { "label": "Apple", "value": "time.apple.com" }
          ]
        },
        {
          "key": "timezone",
          ...
          "options": [
            { "label": "UK (GMT/BST)", "value": "GMT0BST,M3.5.0/1,M10.5.0" },
            ...
            { "label": "Central Europe", "value": "CET-1CEST,M3.5.0,M10.5.0" },
            { "label": "Israel", "value": "IST-2IDT,M3.4.4/26,M10.5.0" },
      ...
      "fields": [
        {
          ...
          "default": "generic",
          "options": [
            { "label": "Generic (recommended — widest Google TV mapping)", "value": "generic" },
            { "label": "Onn full keyboard + remote (0x0484 / 0x5738)", "value": "onn-full-keyboard" },
            { "label": "Google reference RCU (0x0957 / 0x0001)", "value": "google-reference-rcu" },
            { "label": "Apple keyboard (0x05AC / 0x820A)", "value": "apple-keyboard" }
          ]
        }
      ]
    },
